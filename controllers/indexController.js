...
exports.pagmatch = function(req,res){
  res.render('match');
}

// entrar na pagina match tag
exports.pagmatchTag = function(req,res){
  res.render('matchTag');
}
...
exports.updateTag = function (req, res, next) {
  ...
  let p2 = req.body.participant1;
  if (p1 == p2) {
    res.redirect('/editTag/' + req.params.id);
  }
  else {
    let id;
    let id2;
